...
for(element of petCards){
    element.addEventListener('click',petActive)
...
//[our.age,our.inoculations,our.diseases,our.parasites]
...
let data=[]
popUp.addEventListener('click',hidez)
...
let datax = [
  ...
  function deploy() {
    ...
    document.querySelector(".pet-cards-d").children[0].remove()
     ...
     document.querySelector(".pet-cards-d").style.transform="translateX(50px)"
      // .animate([{
